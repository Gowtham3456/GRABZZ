...
export const FilterSidebar = () => {
  ...
  //function for handling the filter change
  ...
  const updateURLParams=(newFilters)=>{
    ...
    //{CATEGORY:"tOP WEAR" SIZ[XL,S]}LIKE THIS
    ...
    navigate(`?${params.toString()}`);//?category=bottom+wear&size=xs%2cs here %2cs is the encoded version of the component
    ...
    <div className="p-4">
      ...
      <div className="mb-6">
        ...
        {sizes.map((size)=>(
          <div key={size} className="flex items-center mb-4">
            ...
            focus:ring-blue-400 border-gray-300"></input>
      ...
      <div className="mb-6">
        ...
        {materials.map((material)=>(
          <div key={material} className="flex items-center mb-4">
            <input type="checkbox" 
            name="material"
            value={material}
            onChange={handleFilterChange}
      ...
      <div className="mb-8">
        ...
        min={0} max={100} className="w-full h-2 bg-gray-400 rounded-lg
